    ...
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled || !isHome ? 'bg-white shadow-md py-3' : 'bg-transparent py-5'}`}>
      <div className="container mx-auto px-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Button variant={isScrolled || !isHome ? "default" : "secondary"} className="bg-[#CE1126] text-white hover:bg-[#b00e20] border-none">
            <a href="https://register.vitabirr.belcashlabs.com/" target="_blank" rel="noopener noreferrer">
              {t.nav.getStarted}
            </a>
          </Button>
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          ...
          >
            <div className="flex flex-col p-4 gap-4 overflow-y-auto max-h-[calc(100vh-4rem)]">
              {NAV_LINKS.map(link => (
                <a 
                  key={link.name} 
                  href={isHome ? link.href : `/${link.href}`}
                  onClick={(e) => handleLinkClick(e, link.href)}
                  className="text-lg font-medium text-[#002147] hover:text-[#CE1126] py-2"
                >
                  {t.nav[link.name as keyof typeof t.nav]}
                </a>
              ))}
              <Button className="bg-[#CE1126] text-white" onClick={() => setIsMobileMenuOpen(false)}>
                <a href="https://register.vitabirr.belcashlabs.com/" target="_blank" rel="noopener noreferrer">
                  {t.nav.getStarted}
                </a>
              </Button>
              <button onClick={() => { toggleLanguage(); setIsMobileMenuOpen(false); }} className="flex items-center gap-2 text-lg font-medium text-[#002147] hover:text-[#CE1126] py-2">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Button size="lg" className="bg-[#CE1126] hover:bg-[#b00e20] text-white text-lg h-14 px-8">
              <a href="https://register.vitabirr.belcashlabs.com/" target="_blank" rel="noopener noreferrer" className="flex items-center">
                {t.hero.registerBtn}
                ...
                <div className="space-y-8">
                  <div className="flex items-center gap-6">
                    ...
                    <div>
                      ...
                      <p className="text-lg font-bold">8539</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-6">
                    <div className="w-12 h-12 bg-white/10 rounded-xl flex items-center justify-center">
    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-[#002147] mb-4">Download Our Apps</h2>
          <p className="text-slate-600 text-lg">Get started with Vitabirr on your mobile device</p>
        </div>

        <div className="grid md:grid-cols-2 gap-12 max-w-4xl mx-auto">
          {/* User App Downloads */}
          <div className="text-center">
            <h3 className="text-2xl font-bold text-[#002147] mb-6">User App</h3>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="https://play.google.com/store/apps/details?id=com.belcash.vitabirr"
                target="_blank"
              ...
              <a
                href="https://apps.apple.com/app/vitabirr-user/id0000000000"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 bg-black text-white px-6 py-3 rounded-lg hover:bg-gray-800 transition-colors"
              >
          ...
          {/* Merchant App Downloads */}
          <div className="text-center">
            <h3 className="text-2xl font-bold text-[#002147] mb-6">Merchant App</h3>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="https://play.google.com/store/apps/details?id=com.belcash.vitabirrMerchant"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 bg-black text-white px-6 py-3 rounded-lg hover:bg-gray-800 transition-colors"
              >
              ...
              <a
                href="https://apps.apple.com/app/vitabirr-merchant/id0000000000"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 bg-black text-white px-6 py-3 rounded-lg hover:bg-gray-800 transition-colors"
              >
